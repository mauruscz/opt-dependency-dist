...
files = [i for i in os.listdir("./mur") if i.endswith("txt")]
files_new = []
...
for file in files:
	...
	fp = open("mur/" +filetxt,encoding="windows-1252")
	data = fp.read()
	...
	open("treebanks-mur/out-" +filetxt, 'w').close()  
	...
	for i in range (0,chunks):
		...
		for i in range(0, len(res)):
			with open("treebanks-mur/out-" +filetxt, 'a') as f:
